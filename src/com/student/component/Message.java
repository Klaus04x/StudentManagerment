...
public class Message extends javax.swing.JPanel {
    ...
    public void showMessage(MessageType messageType, String message){
        ...
        if(messageType == MessageType.SUCCESS){
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/com/student/icon/success.png")));
        }else{
            lbMessage.setIcon(new ImageIcon(getClass().getResource("/com/student/icon/error.png")));
        }
    }
    ...
    private void initComponents() {
        ...
        lbMessage.setBackground(new java.awt.Color(214, 217, 223));
